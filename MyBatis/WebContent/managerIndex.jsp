...
<div class="row clearfix" id="Layer2">
		<div class="col-md-6 column">
			...
			<button onclick="firm()" type="button" class="btn btn-default btn-block btn-success">上传</button>
			<button onclick="f_DL()" type="button" class="btn btn-default btn-block btn-success">下载</button>
